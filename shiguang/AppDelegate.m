...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [AMapLocationServices sharedServices].apiKey = @"1c55085b7fceda2b7b5b439b63babdf4";
...
-(void)createLocalNotification {
    ...
    notification.alertBody = @"你瞅啥";
    notification.applicationIconBadgeNumber = 1314;
    notification.userInfo = @{@"type":@"animal"};
