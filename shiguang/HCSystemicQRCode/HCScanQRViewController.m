...
-(void)createUI {
    UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake(50, 430, WIDTH-100, 20)];
    label1.text = @"将二维码放入框内，即可自动扫描";
    label1.font = [UIFont systemFontOfSize:14];
    label1.textColor = [UIColor grayColor];
    label1.textAlignment = NSTextAlignmentCenter;
    [self.view addSubview:label1];
    
    UIImageView *image = [[UIImageView alloc] initWithFrame:CGRectMake(140, 450, 20, 20)];
    image.image = [UIImage imageNamed:@"icon_scan_barcode@3x"];
    [self.view addSubview:image];
    
    UILabel *label2 = [[UILabel alloc] initWithFrame:CGRectMake(170, 450, WIDTH-100, 20)];
    label2.text = @"扫描取票";
